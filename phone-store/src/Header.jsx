...
export default function Header() {
  ...
  return (
    <div className="justify-center items-center flex gap-[10px] shadow-[0px_0px_8px_0px_black] !p-[10px] rounded-[5px]">
      <img
        className="w-[130px] h-[60px] border-[solid] border-[1px] border-[#eeeeeed4] rounded-[10px]"
      ...
      <div className="text-[20px] flex gap-[15px] items-center">
        <i className="duration-500 hover:-translate-y-1 fa-solid fa-basket-shopping !p-[5px]"></i>
        <i className="duration-500 fa-solid hover:-translate-y-1 fa-heart !p-[5px]"></i>
        <i className="duration-500 fa-solid hover:-translate-y-1 fa-right-to-bracket !p-[5px]"></i>
      </div>
    </div>
  );
}
